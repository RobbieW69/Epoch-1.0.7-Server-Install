...
```
* Now go to the 'build.sqf' script and type `execVM "\z\addons\dayz_server\custom_buildings\BalotaAddons.sqf";` Restart your server and the map edits you made will work. Note any other addons you want to add you need to keep adding the `execVM "\z\addons\dayz_server\custom_buildings\myCustomMapBuildingScript.sqf";` lines to the build.sqf.
